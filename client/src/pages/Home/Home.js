    ...
    return (
        <>
            ...
            <div className="container overflow-hidden">
                <div className=''>
                    <div className="row">
                        <ColumnBox pictureFilePath="/grey.png" altText="Filler" title="About" text="Financial Planner is a powerful web application that allows you to monitor your finance on the fly. We created financial planner because of the huge inconvenience of having to spend a lot of money on financial planning services. You will also gain full control over your finance and no longer have to rely on other services to be able to manage your budget, expenditures, savings, and income. We also made financial planner cost free so anybody can get started and use our websites tools. What sets our application apart from the other tools available out there is the ability to create your own custom specialized account according to the information you give it. We also have graphs to show a graphical representation of the data, for example a graph to represent your budget or savings. Furthermore, we added tools to handle your expenditures and income so you no longer have to use difficult excel sheets to calculate all of your spending. Once you create an account you will gain access to all of our tools with just a few clicks away and manage your finance in an organized and simple user interface. Once you’ve created an account you will be able to use our tools with simple navigation system that’s built in the application. Additionally, we also have an account recovery option just in case you have lost your password. Now what are you waiting for, create an account and get started now to monitor your finance like never before and enjoy our financial planner web application! " 
                        />
                    </div>
                    <div className="row">
